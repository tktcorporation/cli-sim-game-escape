...
- Cell/character UIs (terminal, TUI): dump the test-backend buffer as text and judge from that. Do not screenshot or screen-record. Follow the project's dump command if it has one.
