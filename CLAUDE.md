...
- `src/games/career/` — Career Simulator ゲーム
...
### Career Simulator — コアコンセプト: 「選択と成長」

**コア体験**: 限られたリソース（時間とお金）をどのスキルに投資するか判断し、
正しい選択でキャリアが加速する実感を得る。

**プレイヤーの感情**: 「独学で知識を上げて事務員になったけど、ここから
プログラマーを目指すか営業を目指すかで必要な投資が全然違う…技術系に行こう！」

**主軸**: 複数のキャリアパスから自分の戦略を選び、資源配分を最適化する。

**デザイン原則**:
- 情報の透明性: 各職業の条件・給料・スキルとの差分を常に見せる
- 分岐のある成長: 技術系・営業系・管理系で投資先が異なる
- 投資と回収のジレンマ: 研修にお金を使うか、投資に回すか
- 自動進行+能動的判断: 給料は自動、研修・転職・投資はプレイヤー判断
- 段階的な開放感: 新しい職業に就ける瞬間の達成感

**現状の課題**:
- 職業10種が少なく、現実のキャリアの幅を表現しきれていない
- 最適パスが1-2本に収束しやすい（技術系一択になりがち）
- 中盤のTier2→Tier3で停滞感が出やすい
- イベント性がなく淡々とスキルを上げるだけになる
- リプレイ性が低い

**強化の方向性**:
- 職業の大幅拡充（医療系・法律系・クリエイティブ系・公務員系など）
- 職業固有パッシブ（経験した職業がスキル効率や評判に永続的に影響）
- ランダムイベント（ヘッドハンティング、不景気、市場変動）
- 会社経営モード（起業家到達後に従業員を雇い組織を拡大）
- 副業・兼業システム
- 詳細デザインは `src/games/career/DESIGN.md` を参照
