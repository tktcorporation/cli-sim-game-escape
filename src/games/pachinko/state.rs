...
pub struct Machine {
    ...
    pub normal_balls_spent: u32,
    pub normal_spins_seen: u32,
}
...
pub struct Ball {
    ...
    pub hit_glow: u8,
    /// 通常時に打ち出された玉か。回転率の分母と分子を同じ区間へ揃えるために
    /// 玉自身が覚えておく (`Machine::normal_balls_spent` 参照)。
    ///
    /// 打ち出しから入賞までは数秒あり、その間に電サポが切れることも大当たりが
